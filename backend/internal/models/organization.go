...
// File: backend/internal/models/organization.go
// Purpose: Models for agency_branch, officer, user, role, user_role, and views.
//
// [INTEGRATION NOTE]: Maps 1-to-1 with the finalized 3NF database schema.
// ============================================================================
...
// UserRole maps to bridge table `user_role`
type UserRole struct {
	UserID uint `db:"user_id" json:"user_id"`
	RoleID uint `db:"role_id" json:"role_id"`
}

// UserProfile represents the aggregated user session profile (with officer info & assigned roles)
